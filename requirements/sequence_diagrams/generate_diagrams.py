#!/usr/bin/env python3
"""
Generate PNG diagrams from PlantUML files in the sequence_diagrams directory.

Usage:
    python generate_diagrams.py                    # Generate all diagrams
    python generate_diagrams.py UC1*.puml          # Generate specific diagram(s)
    python generate_diagrams.py UC1*.puml UC5*.puml  # Generate multiple specific diagrams
"""
...
def generate_all_sequence_diagrams(file_patterns=None):
...
if __name__ == "__main__":
    ...
    generate_all_sequence_diagrams(file_patterns)
